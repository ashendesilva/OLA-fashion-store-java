...
//        respoJsonObject.addProperty("status", false);
//
//        if (!Util.isInteger(prId)) {
//            respoJsonObject.addProperty("message", "Invalid Product Id");
//        } else if (!Util.isInteger(qty)) {
//            respoJsonObject.addProperty("message", "Invalid Product Qty");
//        } else {
//
...
//            if (product == null) {
//                respoJsonObject.addProperty("message", "Product not found");
//            } else {
...
//                            s.save(cart);
//                            tr.commit();
//                            respoJsonObject.addProperty("status", true);
//                            respoJsonObject.addProperty("message", "Product Add to cat successfully");
//                        } else {
//                            respoJsonObject.addProperty("message", "Product quantity not available");
//                        }
//
//                    } else {
...
//                            tr.commit();
//                            respoJsonObject.addProperty("status", true);
//                            respoJsonObject.addProperty("message", "Cart update successfully");
//                        } else {
//                            respoJsonObject.addProperty("message", "Product quantity not available");
//                        }
//
...
//                            respoJsonObject.addProperty("status", true);
//                            respoJsonObject.addProperty("message", "Product Added to the cart");
//                        } else {
//                            respoJsonObject.addProperty("message", "Product quantity not available");
//                        }
//
...
//                            respoJsonObject.addProperty("status", true);
//                            respoJsonObject.addProperty("message", "Product cart updated");
//                        } else {
...
//        }
//
////        ses.getAttribute("sessionCart");
////        respoJsonObject.addProperty("statu", Boolean.TRUE);
